class CWidgetHostGroupGrid extends CWidget {
    ...
    #showDrilldown(site) {
        ...
        const swTotal = +site.switch_total;
        const camTotal = +site.camera_total;
        const swClass = swTotal === 0 ? 'empty' : (+site.switch_active === swTotal ? 'ok' : 'bad');
        const camClass = camTotal === 0 ? 'empty' : (+site.camera_active === camTotal ? 'ok' : 'bad');
        ...
        wrap.style.cssText =
            ...
            + 'background:var(--widget-bg,#f4f6f8);z-index:50;'
        ...
        wrap.innerHTML = ''
            ...
            +     'background:#ffffff !important;border:1px solid #ccd5db !important;border-radius:4px !important;'
            +     'cursor:pointer;padding:0 !important;font-size:20px !important;font-weight:600 !important;'
            +     'line-height:1 !important;color:#1f2328 !important;width:32px !important;height:32px !important;'
            ...
            +     '--accent:#5343d4;display:inline-flex;align-items:baseline;gap:6px;'
            +     'padding:3px 10px;border-radius:4px;'
            +     'background:color-mix(in srgb, var(--accent) 16%, transparent);color:#5343d4;'
            ...
            +   'flex:1;overflow-y:auto;display:grid;gap:12px;padding:12px;'
