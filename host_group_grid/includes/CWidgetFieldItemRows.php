...
class CWidgetFieldItemRows extends CWidgetField {
	...
	public const TARGET_SWITCH = 'switch';
	public const TARGET_CAMERA = 'camera';
	...
	public function setValue($value): self {
		...
		foreach ((array) $value as $row) {
			...
			$target = (string) ($row['target'] ?? self::TARGET_SWITCH);
			if ($target !== self::TARGET_SWITCH && $target !== self::TARGET_CAMERA) {
				$target = self::TARGET_SWITCH;
			}
